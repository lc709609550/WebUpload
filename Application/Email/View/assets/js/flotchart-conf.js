...
//  tracking chart
    ...
    $(function () {
        ...
        plot = $.plot($("#chart-1"),
            [ { data: sin, label: "http://blacktie.co/demo/premium/dashio/dashboard/assets/js/sin(x) = -0.00"},
                { data: cos, label: "http://blacktie.co/demo/premium/dashio/dashboard/assets/js/cos(x) = -0.00" } ], {
                series: {
                    lines: { show: true }
                },
                crosshair: { mode: "x" },
